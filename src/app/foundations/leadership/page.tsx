...
const lessons = [
  {
    ...
    href: '/foundations/leadership/what-leadership-means',
    isActive: true,
  },
  {
    number: 2,
    ...
    href: '/foundations/leadership/leading-by-example',
    isActive: true,
  },
  {
    number: 3,
    ...
    href: '/foundations/leadership/building-trust',
    isActive: true,
  },
  {
    number: 4,
    ...
    href: '/foundations/leadership/making-hard-decisions',
    isActive: true,
  },
  {
    number: 5,
    ...
    href: '/foundations/leadership/developing-others',
    isActive: true,
  },
];
